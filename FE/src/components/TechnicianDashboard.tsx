                              ...
                              <div className="flex gap-1">
                                ...
                                <Button 
                                  ...
                                  onClick={async () => {
                                    ...
                                    try {
                                      // Try to pick a usable id from common fields
                                      const recMap = record as unknown as Record<string, unknown>;
                                      const candidateId = record.recordId || (typeof recMap['vehicleProcessingRecordId'] === 'string' ? recMap['vehicleProcessingRecordId'] as string : (recMap['vehicleProcessingRecordId'] ?? '')) || (typeof recMap['processing_record_id'] === 'string' ? recMap['processing_record_id'] as string : (recMap['processing_record_id'] ?? '')) || (typeof recMap['id'] === 'string' ? recMap['id'] as string : (recMap['id'] ?? '')) || '';
